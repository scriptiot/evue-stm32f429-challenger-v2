...
#else       /*LV_MEM_CUSTOM*/
#  define LV_MEM_CUSTOM_INCLUDE "evm_main.h"   /*Header for the dynamic memory function*/
#  define LV_MEM_CUSTOM_ALLOC   vm_malloc       /*Wrapper to malloc*/
#  define LV_MEM_CUSTOM_FREE    vm_free         /*Wrapper to free*/
#endif     /*LV_MEM_CUSTOM*/
