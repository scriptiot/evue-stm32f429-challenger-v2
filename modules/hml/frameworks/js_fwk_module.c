...
evm_val_t * js_fwk_index_stacks;
evm_val_t * js_fwk_hml_stacks;
evm_val_t * js_fwk_css_stacks;
...
int js_fwk_module(evm_t * e){
    js_fwk_index_stacks = evm_list_create(e, GC_LIST, APP_ROUTER_STACK_SIZE);
    js_fwk_css_stacks = evm_list_create(e, GC_LIST, APP_ROUTER_STACK_SIZE);
    js_fwk_hml_stacks = evm_list_create(e, GC_LIST, APP_ROUTER_STACK_SIZE);
